...
| `swath.replay.delimiter.object_lookahead.delegations` | counter | Bare-object lookahead refills delegated to the ordinary range-reader pool. Common-prefix-only rollups leave it at zero. |
