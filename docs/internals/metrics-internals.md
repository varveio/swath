...
| `SORT` | `page_run_header_corruption` | the page-run v2 header envelope had an invalid version/length/TLV, missing or unknown ordering mode, or CRC32C mismatch. The segment aborts with typed `page_run_header_corruption` | |
