...
/**
 * <b>The policy seam</b> (swath-notes' 2026-07-26 simulator campaign): the seed step's descent — the
 ...
 *
 * <p><b>Source-agnostic (seam-notes.md):</b> no S3/protocol type (no SDK response class, no XML/wire
