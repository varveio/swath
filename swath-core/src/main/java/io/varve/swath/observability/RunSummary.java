...
public record RunSummary(
    ...
    public record TrajectorySummary(
            double[] inFlight,
            double[] progressRate,
            double[] workerPagesPerSec,
            double[] workerKeysFetchedPerSec,
            double[] workerLatencyMinMs,
            double[] workerLatencyMeanMs,
            double[] aimdTargetMin,
            double[] aimdTargetMax,
            double[] aimdTargetLast,
            double[] aimdLatencyBaselineMs,
            double[] aimdLatencyEwmaMs,
            double[] aimdLatencyInflatedFrac,
            double serialFrac,
