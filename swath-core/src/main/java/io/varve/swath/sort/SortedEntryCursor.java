 ...
 * fixture-staging chunk or the {@link io.varve.swath.output.sorted.SortedDatasetCoordinator} merge phase. Backed either by an in-memory
 ...
 */
public interface SortedEntryCursor extends Iterator<ListEntry>, AutoCloseable {
