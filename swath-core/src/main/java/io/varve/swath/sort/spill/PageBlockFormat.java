 ...
 */
public final class PageBlockFormat {
    ...
    public record Header(byte[] minKey, byte[] maxKey, int count, boolean ordered,
                  PageBlockDictionaries dictionaries, boolean[] useDict, PageCompression codec,
    ...
    static Header parseHeader(byte[] record) {
        ...
        try {
            codec = PageCompression.fromCode(codecCode);
