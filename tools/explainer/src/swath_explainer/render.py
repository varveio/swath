...
FACTS_FIELDS = [
    ...
    ("Trace event span (first→last event)", "clocks.trace_event_span.display"),
    ("Visualization playback length", "clocks.video_playback.display"),
    ("Objects", "result.objects"),
    ("API attempts", "result.api_calls"),
    ("Committed listing pages", "result.committed_pages"),
