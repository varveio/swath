...
dependencies {
    ...
    // io.varve.swath.sort.SortedRowGroupReader. `implementation`, not `api`: that reader
    // traffics only in byte[]/long/String, so no io.varve.swath.sim type exposes it and, exactly as for
