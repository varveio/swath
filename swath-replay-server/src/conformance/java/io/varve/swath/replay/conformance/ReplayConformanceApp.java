...
@Command(name = "swath-replay-conformance",
        ...
        description = "Compare recorded S3 ListObjectsV2 HAR responses with replay-server responses.")
public final class ReplayConformanceApp implements Callable<Integer> {
    ...
    @Option(names = "--host", defaultValue = "127.0.0.1", description = "Temporary replay-server bind host.")
    String host;
